...
*/
    ...
    for (int j=0; j<featVec[0].size(); j++)
        {
            std::cout << "Media 3x3: " << (int)featVec[0][j] << "\n";
        }
    for (int j=0; j<featVec[1].size(); j++)
        {
            std::cout << "Desvio Padrao 3x3: " << (int)featVec[1][j] << "\n";
        }
    for (int j=0; j<featVec[2].size(); j++)
        {
            std::cout << "Assimetria 3x3: " << (int)featVec[2][j] << "\n";
        }
    for (int j=0; j<featVec[3].size(); j++)
        {
            std::cout << "Curtose 3x3: " << (int)featVec[3][j] << "\n";
        }
